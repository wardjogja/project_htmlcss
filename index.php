<html>
    <head>
    <meta charset="utf-8">
    <title>Advanced Golang Media</title>
            ...
            <div class="main-left">
                <div class="main-left-top">
                    <div class="main-left-logo">
                        <p><img src="image/logo.png" height="20px" width="40px">Advance Golang <span class="logo-perusahaan">Media</span></p>
                    </div>
                    ...
                    <ul>
                        ...
                        <li><a href="#">Why Advance Golang Media</a></li>
                        <li><a href="#" >Home</a></li>
                    </ul>
                 </div>
                </div>
                <div class="main-left-header">
                    <div class="main-left-header-left">
                        <h1>We give growth to your business</h1>
                        <p>The Leading indonesian IT Partner for your business</p>
                        <p><a href="#" class="btn btn-start">Start the First Month For Free</a></p>
                    </div>
                    <div class="main-left-header-right">
